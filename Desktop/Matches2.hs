...
matches (Opt r) st = matches (Or r Epsilon) st
matches (Plus r) st = matches (Then r (Star r)) st
...
revExp (Literal c)  = Literal c
revExp (Or r1 r2)   = Or (revExp r1) (revExp r2)
